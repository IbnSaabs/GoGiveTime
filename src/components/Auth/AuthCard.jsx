...
export const AuthCard = ({
  ...
  return (
    <div className="auth-card absolute top-10 px-3 sm:px-32 pt-10 pb-40 object-center rounded-3xl border max-h-[90%]  w-[95vw]  lg:w-3/6  bg-white z-10">
      ...
      {googleAuth ? (
        ...
        <p className="mt-5 w-8/12 sm:w-10/12 mx-auto text-center text-md text-gray-400">
          {subText}
        </p>
      )}
