...
const Hero = () => {
  return (
    <div className="hero flex justify-center h-[417px] sm:h-[831px] bg-center sm:bg-top">
      <div className="mt-20 sm:top-[294px] h-[175px] sm:h-[352px] w-[300px] sm:w-[637px] sm:left-[400px] sm:absolute text-center">
        ...
        <p className="text-center top-[202px] sm:top-[462px] h-[36px] sm:h-[84px] w-[300px] sm:w-[637px] left-[109px] sm:left-[447px] font-[300px] text-[12px] sm:text-[28px] sm:leading-[28.8px] mt-4">
        ...
        <div className="flex justify-center mt-8">
          <div className="flex items-center p-0 top-[253px] sm:top-[590px] h-[26px] sm:h-[56px] w-[175px] sm:w-[389px] left-[147px]    
          sm:left-[563px] gap-[12px] sm:gap-[24px]">
            ...
            <div className="flex justify-center items-center p-0 top-[12px] h-[24px] sm:h-[84px] w-[92px] sm:w-[183px] left-[13.5px] gap-[4px] sm:gap-[8px]">
              <img src={play} alt="" className="w-[10px] sm:w-[20px] h-[10px] sm:h-[20px] top-[1px] sm:top-[2px] left-[1px] sm:left-[2px]"/>
