        ...
        <AuthPageLayout text='Sign in' path='/sign-in'>
                ...
                >
                    <div className="grid justify-center mt-3">
                        ...
                        <SubmitButton
                            className='mt-5 text-white bg-blue-400 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-100 font-medium rounded-lg text-sm object-center  px-5 py-2.5 text-center shadow-md'
                            type="button"
                        ...
                        <SubmitButton
                            className='mt-5 text-white bg-blue-400 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-100 font-medium rounded-lg text-sm  px-5 py-2.5 text-center shadow-md'
                            type="button"
