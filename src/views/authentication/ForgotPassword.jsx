    ...
    return(
        <AuthPageLayout text='Sign in' path='/sign-in'>
                ...
                >
                    ...
                    {/* Verify Button */}
                    <SubmitButton
                        className='mt-3 text-white bg-blue-400 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-100 font-medium rounded-lg text-sm  w-full px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
                        type="button"
                        text='Reset Password'
